...
use backend\models\RefgolonganruangSearch;
...
class RefgolonganruangController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->idGolonganRuang]);
        }
    ...
    /**
     * Deletes an existing Refgolonganruang model.
    ...
    {
        if (($model = Refgolonganruang::findOne($id)) !== null) {
            return $model;
        }
